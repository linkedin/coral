...
import com.linkedin.coral.trino.rel2trino.transformers.SqlSelectListTransformer;
...
public class CoralToTrinoSqlCallConverter extends SqlShuttle {
  ...
  public CoralToTrinoSqlCallConverter(Map<String, Boolean> configs) {
    this.sqlCallTransformers = SqlCallTransformers.of(new SqlSelectListTransformer(),
