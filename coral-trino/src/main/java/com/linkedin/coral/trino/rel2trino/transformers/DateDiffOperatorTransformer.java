...
/**
 * This class is a subclass of {@link SourceOperatorMatchSqlCallTransformer} which transforms a Coral SqlCall of "datediff" operator
 * with 2 operands into a Trino SqlCall of an operator named "date_diff"
 */
public class DateDiffOperatorTransformer extends SourceOperatorMatchSqlCallTransformer {
  ...
  private static final SqlOperator TARGET_OPERATOR =
      createSqlOperator("date_diff", hiveToCoralSqlOperator("datediff").getReturnTypeInference());
