...
/**
 * This class is a subclass of {@link SourceOperatorMatchSqlCallTransformer} transforms a Coral SqlCall of "TRUNCATE" operator
 * with 2 operands into a Trino SqlCall of an operator named "TRUNCATE"
 */
public class TruncateOperatorTransformer extends SourceOperatorMatchSqlCallTransformer {
  ...
  private static final SqlOperator TARGET_OPERATOR =
      createSqlOperator("TRUNCATE", SqlStdOperatorTable.TRUNCATE.getReturnTypeInference());
