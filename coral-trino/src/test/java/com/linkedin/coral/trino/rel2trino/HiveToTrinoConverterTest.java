...
public class HiveToTrinoConverterTest {
  ...
  public Object[][] viewTestCasesProvider() {
    return new Object[][] {
        ...
        { "test", "date_calculation_view", "SELECT \"date\"(\"SUBSTR\"('2021-08-20', 1, 10)), \"date\"(TIMESTAMP '2021-08-20'), \"date\"(TIMESTAMP '2021-08-20 00:00:00'), \"date_add\"('day', 1, \"date\"(TIMESTAMP '2021-08-20')), \"date_add\"('day', 1, \"date\"(TIMESTAMP '2021-08-20 00:00:00')), \"date_add\"('day', 1 * -1, \"date\"(TIMESTAMP '2021-08-20')), \"date_add\"('day', 1 * -1, \"date\"(TIMESTAMP '2021-08-20 00:00:00')), \"date_diff\"('day', \"date\"(TIMESTAMP '2021-08-21'), \"date\"(TIMESTAMP '2021-08-20')), \"date_diff\"('day', \"date\"(TIMESTAMP '2021-08-19'), \"date\"(TIMESTAMP '2021-08-20')), \"date_diff\"('day', \"date\"(TIMESTAMP '2021-08-19 23:59:59'), \"date\"(TIMESTAMP '2021-08-20 00:00:00'))\n"
            + "FROM \"test\".\"tablea\"" },
