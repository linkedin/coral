...
/**
 * This transformer converts a UDF SqlCall name from the UDF class name (e.g., `com.linkedin.HiveUDF`)
 ...
 */
public class CoralUDFTransformer extends SqlCallTransformer {
  private static final Logger LOG = LoggerFactory.getLogger(CoralUDFTransformer.class);
  ...
  public CoralUDFTransformer(Set<SparkUDFInfo> sparkUDFInfos) {
