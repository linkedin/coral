...
public class SparkSqlRewriter extends SqlShuttle {
  ...
  public SqlNode visit(SqlCall call) {
    ...
    } else if (call.getOperator().getKind() == SqlKind.CAST
      && SqlUtil.isNull(call.getOperandList().get(0))
      && call.getOperandList().get(1).toSqlString(SparkSqlDialect.INSTANCE).getSql()
        .equals(SqlTypeName.NULL.getName())) {
