...
public class RelDataTypeToSparkDataTypeStringConverterTest {
  ...
  public void testPrimitiveRelDataType() {
    Multimap<String, SqlTypeName> sparkDataTypeStringToSqlTypeNameMap = new ImmutableMultimap.Builder<String, SqlTypeName>()
        .put("\"string\"", SqlTypeName.VARCHAR)
        .put("\"integer\"", SqlTypeName.INTEGER)
        .put("\"short\"", SqlTypeName.SMALLINT)
        ...
        .put("\"calendarinterval\"", SqlTypeName.INTERVAL_DAY)
        .put("\"binary\"", SqlTypeName.BINARY)
        .put("\"null\"", SqlTypeName.NULL)
        .build();
  ...
  public void testArrayRelDataType() {
    String expectedSparkDataTypeSchemaString =
        "{\"type\":\"array\",\"containsNull\":true,\"elementType\":\"integer\"}";
