...
/**
 * Calcite operator representation for the explode function.
 ...
 * map operand type.
 */
public class CoralExplodeOperator extends SqlUnnestOperator {

  public static final CoralExplodeOperator EXPLODE = new CoralExplodeOperator();

  public static final String ARRAY_ELEMENT_COLUMN_NAME = "col";

  public CoralExplodeOperator() {
