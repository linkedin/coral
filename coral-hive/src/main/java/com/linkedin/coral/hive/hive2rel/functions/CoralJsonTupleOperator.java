...
public class CoralJsonTupleOperator extends SqlFunctionalOperator {
  public static final CoralJsonTupleOperator JSON_TUPLE = new CoralJsonTupleOperator();

  public CoralJsonTupleOperator() {
