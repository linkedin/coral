...
public class HiveToRelConverter extends ToRelConverter {
  ...
  public HiveToRelConverter(HiveMetastoreClient hiveMetastoreClient) {
    this(hiveMetastoreClient, new StaticHiveFunctionRegistry());
  }

  public HiveToRelConverter(HiveMetastoreClient hiveMetastoreClient, FunctionRegistry functionRegistry) {
    super(hiveMetastoreClient);
    this.functionResolver = new HiveFunctionResolver(functionRegistry, new ConcurrentHashMap<>());
