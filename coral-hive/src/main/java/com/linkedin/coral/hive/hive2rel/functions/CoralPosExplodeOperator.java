...
/**
 * Calcite operator representation for the posexplode function.
 ...
 */
public class CoralPosExplodeOperator extends SqlUnnestOperator {

  public static final CoralPosExplodeOperator POS_EXPLODE = new CoralPosExplodeOperator();

  public static final String ARRAY_ELEMENT_POS_NAME = "pos";
  public static final String ARRAY_ELEMENT_VAL_NAME = "col";

  public CoralPosExplodeOperator() {
