...
public class CoralNamedStructFunction extends SqlUserDefinedFunction {
  public static final CoralNamedStructFunction NAMED_STRUCT = new CoralNamedStructFunction();

  public CoralNamedStructFunction() {
