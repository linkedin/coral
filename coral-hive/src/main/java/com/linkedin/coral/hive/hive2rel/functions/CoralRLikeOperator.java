...
public class CoralRLikeOperator extends SqlSpecialOperator {

  public static final CoralRLikeOperator RLIKE = new CoralRLikeOperator("RLIKE", false);
  public static final CoralRLikeOperator REGEXP = new CoralRLikeOperator("REGEXP", false);

  private final boolean negated;

  /**
   * Creates an operator to represent the RLIKE operator as a Calcite operator
   *  @param name   Operator name
   * @param negated Whether this is 'NOT LIKE'
   */
  public CoralRLikeOperator(String name, boolean negated) {
