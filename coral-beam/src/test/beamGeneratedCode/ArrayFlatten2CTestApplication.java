...
public class ArrayFlatten2CTestApplication {
  ...
  private static final Schema PROJECT4_SCHEMA =
      new Schema.Parser()
          .parse(
              "{\"type\":\"record\",\"name\":\"record0\",\"namespace\":\"rel_avro\",\"fields\":[{\"name\":\"key\",\"type\":[\"string\",\"null\"]},{\"name\":\"longCol\",\"type\":[\"long\",\"null\"]},{\"name\":\"doubleCol\",\"type\":[\"double\",\"null\"]}]}");
                ...
                MapElements.via(
                    new SimpleFunction<KV<String, GenericRecord>, KV<String, GenericRecord>>() {
                      public KV<String, GenericRecord> apply(KV<String, GenericRecord> stream1KV) {
                        ...
                        final GenericArray var2 = (GenericArray) stream1Record.get("doubleArray");
                    ...
                    new SimpleFunction<
                      ...
                      public Collection<KV<String, GenericRecord>> apply(
                        ...
                        return BeamArrayFlatten.flatten(
                            project2KV,
                            ImmutableList.of("longCol", "doubleCol"),
                            ARRAYFLATTEN3_SCHEMA);
                      }
                    }))
                ...
                MapElements.via(
                    new SimpleFunction<KV<String, GenericRecord>, KV<String, GenericRecord>>() {
                      public KV<String, GenericRecord> apply(
                        ...
                        final Long var1 = (Long) arrayflatten3Record.get("lElem");
                        project4Record.put("longCol", var1);
                        final Double var2 = (Double) arrayflatten3Record.get("dElem");
                        project4Record.put("doubleCol", var2);
