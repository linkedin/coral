...
public class UDFTransformerTest {
  ...
  public void testInputOperatorTransformer() {
    ...
    testTransformation(tableThreeQuery, tableThreeConfig, targetUDF,
        null, null,
    ...
    testFailedTransformation(tableThreeQuery, tableThreeConfig, defaultUDF,
        null, null,
  ...
  public void testInvalidArgumentsOperatorTransformer() {
    ...
    testFailedTransformation(tableThreeQuery, tableThreeConfig, targetUDF,
        null, null,
