...
public class CalcitePigOperatorMap {
  ...
  private static final Map<String, Function> UDF_MAP = ImmutableMap.<String, Function>builder()
      ...
      .put("base64", PigUDF.create("base64"))
      .put("concat", PigUDF.create("concat"))
      .put("concat_ws", PigUDF.create("concat_ws"))
      .put("conv", PigUDF.create("conv"))
      .put("decode", PigUDF.create("decode"))
      .put("degrees", PigUDF.create("degrees"))
      .put("e", PigUDF.create("e"))
      .put("factorial", PigUDF.create("factorial"))
      .put("hex", PigUDF.create("hex"))
      .put("instr", PigUDF.create("instr"))
      .put("negative", PigUDF.create("negative"))
      .put("nvl", PigUDF.create("nvl"))
      .put("pi", PigUDF.create("pi"))
      .put("positive", PigUDF.create("positive"))
      .put("pow", PigUDF.create("pow"))
      .put("power", PigUDF.create("power"))
      .put("radians", PigUDF.create("radians"))
      .put("regexp_replace", PigUDF.create("regexp_replace"))
      .put("split", PigUDF.create("split"))
      .put("unbase64", PigUDF.create("unbase64"))
      .put("unhex", PigUDF.create("unhex"))
      // Dali UDFs
      ...
      .put("abs", PigBuiltinFunction.create("ABS"))
      .put("atan", PigBuiltinFunction.create("ATAN"))
      .put("acos", PigBuiltinFunction.create("ACOS"))
      .put("cbrt", PigBuiltinFunction.create("CBRT"))
      .put("ceil", PigBuiltinFunction.create("CEIL"))
      .put("ceiling", PigBuiltinFunction.create("CEIL"))
      .put("cos", PigBuiltinFunction.create("COS"))
      .put("exp", PigBuiltinFunction.create("EXP"))
      .put("floor", PigBuiltinFunction.create("FLOOR"))
      .put("log10", PigBuiltinFunction.create("LOG10"))
      .put("lcase", PigBuiltinFunction.create("LOWER"))
      .put("ln", PigBuiltinFunction.create("LOG"))
      .put("lower", PigBuiltinFunction.create("LOWER"))
      .put("ltrim", PigBuiltinFunction.create("LTRIM"))
      .put("regexp_extract", PigBuiltinFunction.create("REGEX_EXTRACT"))
      .put("rtrim", PigBuiltinFunction.create("RTRIM"))
      .put("sin", PigBuiltinFunction.create("SIN"))
      .put("sqrt", PigBuiltinFunction.create("SQRT"))
      .put("tan", PigBuiltinFunction.create("TAN"))
      .put("trim", PigBuiltinFunction.create("TRIM"))
      .put("upper", PigBuiltinFunction.create("UPPER"))
      .put("ucase", PigBuiltinFunction.create("UPPER"))
      // Special Pig Builtin Functions
      .put("if", PigIfFunction.create())
      .put("log", PigLogFunction.create())
      .put("log2", PigLog2Function.create())
      .put("rand", PigRandomFunction.create())
      .put("round", PigRoundFunction.create())
      .put("substr", PigSubstringFunction.create())
      .put("substring", PigSubstringFunction.create())
      .build();
