...
public class CalcitePigUDFTest {
  ...
  public static void testPigSubstringUDF() throws IOException, ParseException {
    ...
    final String[] pigFunctionCalls = {
        "SUBSTRING(str, (int)(i2) - 1, (int)SIZE(str))",
        "SUBSTRING(str, (int)(i2) - 1, (int)((int)(i2) - 1) + (int)(i1))",
        "SUBSTRING(str, (int)(i2) - 1, (int)SIZE(str))",
        "SUBSTRING(str, (int)(i2) - 1, (int)((int)(i2) - 1) + (int)(i1))",
    };
  ...
  public static void testAllPigBuiltinFunctions() throws IOException, ParseException {
    ...
    final PigFunctionTest[] testSuite = {
        PigFunctionTest.create("atan", "ATAN", "i1", "(0.7853981633974483)"),
        PigFunctionTest.create("acos", "ACOS", "i1", "(0.0)"),
        PigFunctionTest.create("abs", "ABS", "i1", "(1)"),
        PigFunctionTest.create("abs", "ABS", "i_1", "(1)"),
        PigFunctionTest.create("cbrt", "CBRT", "i1", "(1.0)"),
        PigFunctionTest.create("cbrt", "CBRT", "i2", "(1.2599210498948732)"),
        PigFunctionTest.create("ceil", "CEIL", "fl1", "(1.0)"),
        PigFunctionTest.create("ceil", "CEIL", "fl2", "(2.0)"),
        PigFunctionTest.create("ceil", "CEIL", "fl3", "(2.0)"),
        PigFunctionTest.create("ceiling", "CEIL", "fl1", "(1.0)"),
        PigFunctionTest.create("ceiling", "CEIL", "fl2", "(2.0)"),
        PigFunctionTest.create("ceiling", "CEIL", "fl3", "(2.0)"),
        PigFunctionTest.create("cos", "COS", "i1", "(0.5403023058681398)"),
        PigFunctionTest.create("exp", "EXP", "fl1", "(2.718281828459045)"),
        PigFunctionTest.create("floor", "FLOOR", "fl1", "(1.0)"),
        PigFunctionTest.create("floor", "FLOOR", "fl2", "(1.0)"),
        PigFunctionTest.create("floor", "FLOOR", "fl3", "(1.0)"),
        ...
        PigFunctionTest.create("upper", "UPPER", "str", "(ABCD)")
    };
  ...
  public static void testAllPigUDF() throws IOException, ParseException {
    ...
    final PigFunctionTest[] testSuite = {
        PigFunctionTest.create("base64", "bin", "(YmluYXJ5)"),
        PigFunctionTest.create("concat", "str, exstr", "(aBcDeFg )"),
        PigFunctionTest.create("concat_ws", "'Z', str, exstr", "(aBcDZeFg )"),
        PigFunctionTest.create("conv", "i3, 4, i2", "(11)"),
        PigFunctionTest.create("decode", "bin, 'UTF-8'", "(binary)"),
        PigFunctionTest.create("degrees", "fl1", "(57.29577951308232)"),
        PigFunctionTest.create("factorial", "i3", "(6)"),
        PigFunctionTest.create("hex", "str", "(61426344)"),
        PigFunctionTest.create("hex", "i3", "(3)"),
        PigFunctionTest.create("hex", "bin", "(62696E617279)"),
        PigFunctionTest.create("instr", "str, substr", "(3)"),
        PigFunctionTest.create("instr", "str, exstr", "(0)"),
        PigFunctionTest.create("negative", "i1", "(-1)"),
        PigFunctionTest.create("negative", "i_1", "(1)"),
        PigFunctionTest.create("nvl", "i_1, 10", "(-1)"),
        PigFunctionTest.create("positive", "i1", "(1)"),
        PigFunctionTest.create("positive", "i_1", "(-1)"),
        PigFunctionTest.create("pow", "i2, i2", "(4.0)"),
        PigFunctionTest.create("pow", "fl2, fl2", "(1.3056984531291909)"),
        PigFunctionTest.create("power", "i2, i2", "(4.0)"),
        PigFunctionTest.create("power", "fl2, fl2", "(1.3056984531291909)"),
        PigFunctionTest.create("radians", "i3", "(0.05235987755982988)"),
        PigFunctionTest.create("regexp_replace", "str, substr, exstr", "(aBeFg )"),
        PigFunctionTest.create("split", "str, 'c'", "({(aB),(D)})"),
        PigFunctionTest.create("unbase64", "str", "(h\u0017\u0003)")
    };
  ...
  private static void runTestSuite(String sqlTemplate, String expectedPigLatinTemplate,
    ...
    for (int i = 0; i < testSuite.length; ++i) {
      ...
      final String[] expectedPigLatin = String.format(expectedPigLatinTemplate, pigFunctionTest.getPigName(),
          pigFunctionTest.getOperands()).split("\n");
  ...
  private static String[] renameUDFPackage(String[] pigLatinStatements) {
    for (int i = 0; i < pigLatinStatements.length; ++i) {
      pigLatinStatements[i] = pigLatinStatements[i].replace(
          "dali.data.pig.udf", "org.apache.pig.builtin");
    }
