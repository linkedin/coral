 ...
 */
public final class CoralVarcharType implements CoralDataType {
   ...
   */
  public CoralVarcharType(int length, boolean nullable) {
    if (length <= 0) {
  ...
  public boolean equals(Object o) {
    ...
    if (o == null || getClass() != o.getClass())
      return false;
    CoralVarcharType that = (CoralVarcharType) o;
