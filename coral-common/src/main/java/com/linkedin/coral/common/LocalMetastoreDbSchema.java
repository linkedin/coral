 ...
 *
 * <p>This class is a replacement for {@link HiveDbSchema} to work with localMetastore in coral-spark-plan module.
 */
public class LocalMetastoreDbSchema implements Schema {

  private final Map<String, Map<String, List<String>>> localMetastore;
  private final String dbName;

  public LocalMetastoreDbSchema(Map<String, Map<String, List<String>>> localMetastore, String dbName) {
