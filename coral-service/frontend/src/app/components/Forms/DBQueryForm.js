...
export default function DBQueryForm() {
  ...
  return (
      <>
            ...
            <form className='space-y-6' action='#' method='POST' onSubmit={onSubmit} >
              <div className='col-span-full'>
                ...
                <textarea
                    ...
                    value={statement} // Bind the value to the state variable
                    onChange={(e) => setStatement(e.target.value)} // Update the state on change
                ></textarea>
                </div>
        ...
        <ResultModal open={modalIsOpen} onClose={handleCloseModal} result={creationResult} />
