          ...
          >
            <div className='col-span-full'>
              ...
              <div className='mt-2'>
                <textarea
                  ...
                  name='query'
                  rows='3'
                  className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-coral-blue sm:text-md sm:leading-6'
            ...
            <div className='flex justify-between'>
              ...
              <select
                id='targetLanguage'
                name='targetLanguage'
                className='ml-6 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-md sm:leading-6'
              >
                <option value='trino'>Trino</option>
                <option value='spark'>Spark</option>
              </select>
            ...
            <div className='col-span-full'>
              ...
              <div className='mt-2'>
                <select
                  id='rewriteType'
                  name='rewriteType'
                  className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:w-1/2 sm:max-w-xs sm:text-md sm:leading-6'
                >
            ...
            <div>
              {isLoading ? (
                ...
                <button
                  type='submit'
                  className='flex w-full justify-center rounded-md px-4 py-2 text-md font-semibold leading-6 text-white shadow-sm bg-coral-blue hover:bg-coral-blue-lighter focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'
                >
                  Translate
                </button>
              )}
