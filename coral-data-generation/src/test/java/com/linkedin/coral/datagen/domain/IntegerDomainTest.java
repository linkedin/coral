...
public class IntegerDomainTest {
    ...
    public void testMultipleIntervals() {
        ...
        List<IntegerDomain.Interval> intervals = Arrays.asList(
            new IntegerDomain.Interval(1, 5),
            new IntegerDomain.Interval(10, 15),
            new IntegerDomain.Interval(20, 30)
        );
    ...
    public void testOverlappingIntervalsMerge() {
        ...
        List<IntegerDomain.Interval> intervals = Arrays.asList(
            new IntegerDomain.Interval(1, 10),
            new IntegerDomain.Interval(5, 15),
            new IntegerDomain.Interval(20, 30)
        );
        IntegerDomain domain = IntegerDomain.of(intervals);
    ...
    public void testAdjacentIntervalsMerge() {
        ...
        List<IntegerDomain.Interval> intervals = Arrays.asList(
            new IntegerDomain.Interval(1, 10),
            new IntegerDomain.Interval(11, 20),
            new IntegerDomain.Interval(30, 40)
        );
        IntegerDomain domain = IntegerDomain.of(intervals);
    ...
    public void testMultiIntervalIntersection() {
        ...
        List<IntegerDomain.Interval> intervals1 = Arrays.asList(
            new IntegerDomain.Interval(1, 20),
            new IntegerDomain.Interval(30, 50)
        );
        List<IntegerDomain.Interval> intervals2 = Arrays.asList(
            new IntegerDomain.Interval(10, 35),
            new IntegerDomain.Interval(45, 60)
        );
